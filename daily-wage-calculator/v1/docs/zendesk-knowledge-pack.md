...
- Super admin [Articles: 14243760419089]
  ...
  ## Navigation Paths
  - Unpaid Leave Request → Approval → Pay Calculation → Payroll Deduction (Leave management workflow) [Articles: 14154746403601]
...
- Access to payroll settings [Articles: 14243704039185]
  ...
  - **Employee's total salary (basic + allowance)**: Monthly salary components used for calculation [Articles: 14154746403601]
- **Number of working days in the month**: Can be calendar days (30) or working days (22) [Articles: 14154746403601]
...
- **Calculation basis**: Choose from: custom days, calendar days, or working days [Articles: 14243760419089]
  ...
  ## Outputs & Results
  - **Automatic pay deduction**: Reflected on the payroll table [Articles: 14154746403601]
- **Daily pay rate**: Calculated by dividing salary by actual working days [Articles: 14154746403601]
...
- **Prorated salary calculation**: Proportionally adjusted employee compensation [Articles: 14243760419089]
  ...
  **When to use**: For processing unpaid leave salary deductions
  **Steps**:
    1. Receive unpaid leave request
...
### Update Salary Proration [Articles: 14243760419089]
  ...
  **Steps**:
  ...
  ## Rules & Limitations
  - Daily pay = Salary Amount (Basic + Allowance) / Number of actual working days [Articles: 14154746403601]
...
- During open payroll month, must reject and resave prorated salary transactions [Articles: 14243760419089]
...
- Manual transaction management required during open payroll month [Articles: 14243760419089]
  ...
  - Interacts with payroll system, leave management, and employee record systems [Articles: 14154746403601]
- Integrates with Daily Wage Calculator (DWC) and Payroll system [Articles: 14243760419089]


  ## Glossary Terms
  - **Daily Pay**: Salary amount divided by number of actual working days in a month [Articles: 14154746403601]
...
- (ui_step) User can select between custom days, calendar days, and working days [Articles: 14243760419089]
  ...
  - **Introduction to daily wage calculator** (ID: 14243704039185): Introduces a new Daily Wage calculator offering flexible calculation methods for salary proration, leave encashment, and unpaid leave deductions.
  ...
  - **Salary Proration** (ID: 14243760419089): Explains how super admins can update salary proration by selecting different calculation bases in the Daily Wage Calculator, affecting first salary and end-of-service settlement.
